...
void userMain() {
    ...
    printString("1. niti C API test\n");
    printString("2. niti CPP API test\n");
    printString("3. ConsumerProducer C API test\n");
    printString("4. ConsumerProducer CPP API test\n");
    printString("5. ThreadSleep C API test\n");
    printString("6. ThreadSleep CPP API test\n");
    printString("7. System Mode test\n");
    printString("Unesite broj testa? [1-7]\n");
